...
def verify_api_key_only(
    x_api_key: str = Header(..., description="Enter your granted API"),
...
def verify_structure_access(
    x_api_key: str = Header(...,description="Enter X-API key if it allow structure data"),
    db: Session = Depends(get_db)
):
    ...
    # Return success WITHOUT incrementing hits
    return {
        "success": True,
        "valid": True,
